/**
 * ETH Gateway — PAPER TRADING STUB
 *
...
export const tokenMoveToAdmin_new = async (data) => {
  return { status: true, trxId: paperTrxId() };
};
...
export const tokenMoveToUser_new = async (data) => {
  return { status: true, trxId: paperTrxId() };
};

export const ethMovetoAdminCron = async () => {
  // Paper trading: sweep cron disabled
  return true;
};

export const erc20MoveToAdminCron = async () => {
  // Paper trading: sweep cron disabled
  return true;
};
...
export const ethMovetoAdminCron_new = async () => {
  // Paper trading: sweep cron disabled
  return true;
};
...
export const ethMovetoAdmin = async (data) => {
  return { status: true, trxId: paperTrxId() };
};
...
export const ethMovetoUser = async (data) => {
  return { status: true, trxId: paperTrxId() };
};
